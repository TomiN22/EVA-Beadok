...
namespace NegyzetekWinForms
{
    public partial class Form1 : Form
    {
        ...
        private NegyzetekFileDataAccess _dataAccess;
        private bool _enableButtons = false;
        private bool _startPause;
        private Image _pointImg;
        ...
        public Form1()
        {
            ...
            _pointImg = Image.FromFile("./pic/redcircle.PNG");
            ...
            x9ToolStripMenuItem.Click += Menu_9GameClick;
        ...
        private void GameOver(Object? sender, NegyzetekEventArgs e)
        {
            timer1.Stop();
            EnableButtons = false;
        ...
        public void RefreshTable()
        {
            for (int i = 0; i < _model.GetSize; i++)
            {
                for (int j = 0; j < _model.GetSize; j++)
                {
                    ...
                    {
                        _buttonGrid[j, i].BackColor = Color.Green;
                    }
                    ...
                    {
                        _buttonGrid[j, i].Image = _pointImg;
                    }
                }
            }
            EnableButtons = true;
