...
namespace NegyzetekWPF.ViewModel
{
    public class DViewModel : ViewModelBase
    {
        ...
        public DelegateCommand NineGameCommand { get; private set; }
        ...
        public DViewModel(GameModel model)
        {
            ...
            FiveGameCommand = new DelegateCommand(param => OnFiveGame());
            NineGameCommand = new DelegateCommand(param => OnNineGame());
        ...
        private void Model_GameAdvanced(object? sender, NegyzetekEventArgs e)
        {
            //RefreshTable();
            OnPropertyChanged(nameof(P1Time));
            OnPropertyChanged(nameof(P2Time));
        ...
        /// </summary>
        private void Model_GameCreated(object? sender, NegyzetekEventArgs e)
        {
            RefreshTable();
        }
        ...
        private void OnFiveGame()
        {
            Fields.Clear();
            FiveGame?.Invoke(this, EventArgs.Empty);
        }

        private void OnNineGame()
        {
            Fields.Clear();
