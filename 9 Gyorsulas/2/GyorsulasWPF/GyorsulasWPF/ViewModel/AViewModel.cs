...
namespace AsteroidsWPF.ViewModel
{
    public class AViewModel : ViewModelBase
    {
        ...
        public AViewModel(GameModel model)
        {
            ...
            EnableSave = false;
            EnableLoad = true;
            CurrGas = _model.Table.CurrentGas;
        ...
        private void RefreshTable()
        {
            ...
            OnPropertyChanged(nameof(CurrGas));
        ...
        private void Model_STDGameAdvanced(object? sender, AsteroidsEventArgs e)
        {
