...
namespace GyorsulasWinForms
{
    public partial class Form : System.Windows.Forms.Form
    {
        ...
        private void GameOver(Object? sender, AsteroidsEventArgs e)
        {
            timer1.Stop();
            timer2.Stop();
            MessageBox.Show(PlayerTime.ToString(), "Game over!, You're out of fuel!");
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //timer1.Interval = TimeSpan.FromMilliseconds(_model.TimeInterval);
            timer1.Interval = (int)_model.TimeInterval;
            RefreshTable();
        }
