...
namespace AknamezoWPF.ViewModel
{
    public class AViewModel : ViewModelBase
    {
        ...
        private void Model_FastestGameAdvanced(object? sender, AknamezoEventArgs e)
        {
            OnPropertyChanged(nameof(FastestGameTime));
            RefreshTable();
        }

        private void Model_STDGameAdvanced(object? sender, AknamezoEventArgs e)
        {
            RefreshTable();
            OnPropertyChanged(nameof(StdGameTime));
        }

        private void Model_GameAdvanced(object? sender, AknamezoEventArgs e)
        {
            RefreshTable();
            OnPropertyChanged(nameof(GameTime));
            //OnPropertyChanged(nameof(StdGameTime));
        ...
        /// </summary>
        private void Model_GameCreated(object? sender, AknamezoEventArgs e)
        {
            RefreshTable();
        }
