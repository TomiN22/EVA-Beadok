...
namespace TetrisWPF
{
    ...
    public partial class App : Application
    {
        ...
        private void App_Startup(object? sender, StartupEventArgs e)
        {
            ...
            _model = new GameModel(_dataAccess, 0,0);
            _model.GameOver += new EventHandler<TetrisEventArgs>(Model_GameOver);

            // nézemodell létrehozása
            _viewModel = new AViewModel(_model);
            _viewModel.Lvl1Game += new EventHandler(ViewModel_Lvl1Game);
            _viewModel.Lvl2Game += new EventHandler(ViewModel_Lvl2Game);
            _viewModel.Lvl3Game += new EventHandler(ViewModel_Lvl3Game);
        ...
        private void ViewModel_Lvl1Game(object? sender, EventArgs e)
        {
            _model = new GameModel(_dataAccess, 16, 4);
        ...
        private void ViewModel_Lvl2Game(object? sender, EventArgs e)
        {
            _model = new GameModel(_dataAccess, 16, 8);
            _viewModel.Model = _model;
            _viewModel.CreateTable();
            _model.GameOver += Model_GameOver;
            _timer.Start();
        ...
        private void ViewModel_Lvl3Game(object? sender, EventArgs e)
        {
            _model = new GameModel(_dataAccess, 16, 12);
            _viewModel.Model = _model;
            _viewModel.CreateTable();
            _model.GameOver += Model_GameOver;
            _timer.Start();
        ...
        private void Model_GameOver(object? sender, TetrisEventArgs e)
        {
            ...
            MessageBox.Show("You've lasted this long: "+_viewModel.GameTime.ToString(), "Game over!");
