...
namespace AsteroidsModel.Model
{
    public class GameModel
    {
        ...
        public void GenerateFields()
        {
            ...
            _table.PCurrent[1] = (GetSize-1); _table.PCurrent[0] = (GetSize/2);
        ...
        public void GenerateMeteors()
        {
            ...
            if (_table.GameTime >= 10)
            {
                ...
                for (int i = 0; i < numberOfEnemies; i++)
                {
                    ...
                    Meteor meteor = new Meteor(position, 0);
                    meteor.MeteorStepEvent += OnMeteorStep;
                    Meteors.Add(meteor);
                    Table.SetTableValue(position, 0, 2);
                }
            }
            else
            {
        ...
        public void TakeDownAsteroids()
        {
            for (int i = 0; i < GetSize; i++)
            {
                if (_table.GetTableValue(i, GetSize-1) == 2)
                {
