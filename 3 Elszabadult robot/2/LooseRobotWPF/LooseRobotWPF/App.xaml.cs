...
using LooseRobotWPF.ViewModel;
using Microsoft.Win32;

namespace LooseRobotWPF
{
    public partial class App : Application
    {
        private GameModel _model = null!;
        private LRViewModel _viewModel = null!;
        private MainWindow _view = null!;
        private ILooseRobotDataAccess? _dataAccess;
        ...
        private void App_Startup(object? sender, StartupEventArgs e)
        {
            ...
            _model.GameOver += new EventHandler<LooseRobotEventArgs>(Model_GameOver);

            // nézemodell létrehozása
            _viewModel = new LRViewModel(_model);
        ...
        private void Model_GameOver(object? sender, LooseRobotEventArgs e)
        {
            ...
            _viewModel.EnableButtons = false;
             ...
             MessageBox.Show(_viewModel.PlayerTime.ToString() , "Finally, you won!");
