...
namespace KameleonWPF.ViewModel
{
    public class DViewModel : ViewModelBase
    {
        ...
        public DViewModel(GameModel model)
        {
            ...
            SevenGameCommand = new DelegateCommand(param => OnSevenGame());
        ...
        private void RefreshTable()
        {
            ...
            foreach (Field field in Fields)
            {
                ...
                {
                    field.Colour = "LightGreen"; OnPropertyChanged("Colour");
                }
