...
namespace KameleonWPF
{
    ...
    public partial class App : Application
    {
        ...
        private void App_Startup(object? sender, StartupEventArgs e)
        {
            ...
            _viewModel.SevenGame += new EventHandler(ViewModel_7Game);
        ...
        private void ViewModel_3Game(object? sender, EventArgs e)
        {
            ...
            _model = new GameModel(_dataAccess, 3);
        ...
        private void ViewModel_7Game(object? sender, EventArgs e)
        {
            if (_model != null)
            {
                _model.GameOver -= Model_GameOver;
