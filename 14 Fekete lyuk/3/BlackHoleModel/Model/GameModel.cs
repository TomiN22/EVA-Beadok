        ...
        public void Step(int x, int y)
        {
            if (!IsGameOver)
            {
                if (Table.Player == 1)
                {
                    ...
                    if((_table.GetTableValue(x,y) == 0 || _table.GetTableValue(x, y) == 1) && Table.P1Current[0] != -1 && Table.P1Current[1] != -1 && ((x==Table.P1Current[0]-1 && y==Table.P1Current[1]) || (x==Table.P1Current[0]+1 && y==Table.P1Current[1]) || (x==Table.P1Current[0] && y==Table.P1Current[1]-1) || (x==Table.P1Current[0] && y==Table.P1Current[1]+1)))
                    {
