    ...
    public class RobotModel
    {
        ...
        public void CheckSum()
        {
            ...
            if (_table.Moves == 0)
            {
                ...
                {
                    _isGameOver= true; Winner = 1; OnGameOver(Win.Red);
                }
                else if (BlueCount>RedCount)
                {
                    _isGameOver= true; Winner = 2; OnGameOver(Win.Blue);
                }
                else if (RedCount==RedCount)
                {
                    _isGameOver= true; Winner = 3; OnGameOver(Win.Draw);
                }
            }
            else if (RedCount==0)
            {
