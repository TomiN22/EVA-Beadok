...
namespace AwariWPF.ViewModel
{
    public class DViewModel : ViewModelBase
    {
        ...
        private BitmapImage _dotImage = new BitmapImage(new Uri("./pic/redcircle.PNG", UriKind.Relative));
        ...
        public DelegateCommand TwelveGameCommand { get; private set; }
        ...
        public event EventHandler? TwelveGame;
        ...
        public DViewModel(GameModel model)
        {
            ...
            TwelveGameCommand = new DelegateCommand(param => OnTwelveGame());
        ...
        private void RefreshTable()
        {
            ...
            foreach (Field field in Fields)
            {
                if (_model.Table.GetTableValue(field.X, field.Y) == -1)
                {
                    ...
                    field.IsEnabled = false; OnPropertyChanged("IsEnabled");
                }
                if (_model.Table.GetTableValue(field.X, field.Y) == 1)
                {
                    field.Colour = "Blue"; OnPropertyChanged("Colour");
                    field.IsEnabled = true; OnPropertyChanged("IsEnabled");
                    field.Text = _model.Table.GetTableNum(field.X,field.Y).ToString();
                }
        ...
        /// </summary>
        private void Model_GameCreated(object? sender, AwariEventArgs e)
        {
            RefreshTable();
        }
        ...
        private void OnTwelveGame()
        {
            Fields.Clear();
            TwelveGame?.Invoke(this, EventArgs.Empty);
        }
