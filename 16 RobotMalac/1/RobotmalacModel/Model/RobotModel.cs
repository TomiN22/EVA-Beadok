...
namespace RobotmalacModel.Model
{
    public class RobotModel
    {
        ...
        //move left,move left,move up,move up,move right,move right,move right
        //if (player == 1)
        //{
        //    for(int i=0; i<5; i++)
        //    {
        //        P1StandaloneCMD = command.Split(',');
        //    }

        //    //if (P1StandaloneCMD.Length < 5)
        //    //{
        //    //    P1StandaloneCMD = command.Split(',');
        //    //}
        //    //_table.ActCMD = _p1StandaloneCMD;
        //}
        //else if (player == 2)
        //{
        //    for (int i = 0; i<5; i++)
        //    {
        //        P2StandaloneCMD = command.Split(',');
        //    }
        //    //if (P2StandaloneCMD.Length < 5)
        //    //{
        //    //    P2StandaloneCMD = command.Split(',');
        //    //}
        //    //if (_p2StandaloneCMD.Length == 0)
        //    //{
        //    //    _p1StandaloneCMD = _table.ActCMD;
        //    //}
        //    //_table.ActCMD = _p2StandaloneCMD;
        //}
    }
}
